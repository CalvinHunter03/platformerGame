class StartScene extends Phaser.Scene {
    ...
    create(){
        ...
        this.startText = this.add.text(75, 230, "Arrow keys to move", {
            fontFamily: "Georgia",
            color: "white",
            strokeThickness: 5,
            stroke: "black",
        ...
        this.DJText = this.add.text(250, 200, "Double jump up!", {
            fontFamily: "Georgia",
            color: "white",
            strokeThickness: 5,
            stroke: "black",
        ...
        this.leaveSceneText = this.add.text(545, 210, "Collect all coins to continue", {
            fontFamily: "Georgia",
            color: "white",
            strokeThickness: 5,
            stroke: "black",
        ...
        this.map = this.add.tilemap("Start_map", 18, 18, 40, 20);
    ...
    update(){
        ...
        this.scene.get("hud").scoreText.setText("Coins: " + this.score + " / 5");
