class LevelTwo extends Phaser.Scene {
    ...
    create(){
        ...
        this.blue_background = this.add.image( 0, 0, "blue_background");
        this.blue_background.setScale(4.0);
    
        this.map = this.add.tilemap("Level_two_map", 18, 18, 100, 20);

        this.tileset = this.map.addTilesetImage("platformer_tilepack", "tilemap_tiles");
